    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url()?>"><img src="<?php echo base_url()?>asset/justdoit.png"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            
            <li><a href="<?php echo base_url()?>page/cara_bayar"><i class="glyphicon glyphicon-briefcase"></i> Cara Belanja</a></li>
            <li><a href="<?php echo base_url()?>shopping/tampil_cart"><i class="glyphicon glyphicon-shopping-cart"></i>  Shopping Cart</a></li>
            <li><a href="<?php echo base_url()?>page/hubungi_kami"><i class="glyphicon glyphicon-phone-alt"></i>  Hubungi Kami</a></li>
